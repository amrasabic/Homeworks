package homeworkDrawingAppImproved;
...
//	private static int[] supportedSize = new int[] { 10, 15, 20 };
	...
	public PaintPanel(int height, int width) {
		...
		JButton sizeIncrease = new JButton("Size +");
		...
		JButton sizeDecrease = new JButton("Size -");
	...
	protected void paintComponent(Graphics g) {
		...
		for (int i = 0; i < points.getLength(); i++) {
			...
			g.drawLine(p.getX(), p.getY(), p.getSize(), p.getSize());
		}
